    ...
    <Box bg="white" color="black" w="400px" h="100vh" left="0" p="4">
      ...
      <List mt="5px" ml="3" fontSize="small">
        ...
        <ListItem mb="4" fontWeight="bold">Km
            <List mt="4">
                <ListItem maxW="400px">
                    <Input bg="gray.300" w="38%"  placeholder='Mínima' border="none" mr="2" borderRadius="0"  fontSize="small"/>
                    <Input bg="gray.300" w="38%"  placeholder='Máxima' border="none" ml="" borderRadius="0"  fontSize="small"/>
                </ListItem>
            </List>
        </ListItem>
        <ListItem mb="4" fontWeight="bold">Preço
            <List mt="4">
                <ListItem maxW="400px"> 
                    <Input bg="gray.300" w="38%"  placeholder='Mínimo' border="none" mr="2" borderRadius="0"  fontSize="small"/>
                    <Input bg="gray.300" w="38%"  placeholder='Máximo' border="none" ml="" borderRadius="0"  fontSize="small"/>
                </ListItem>
            </List>
        </ListItem>
      </List>
